...
//   $('.upload-popup-box').load('uploadModal.html');
  ...
  // unfold file tree
  $(document).on('click', 'li[id^=my-drive] i.ic-arrow, li[id^=share-drive] i.ic-arrow, li[id^=parent] i.ic-arrow', function () {
  ...
  // click folder
  $(document).on('click', 'ul[id^=drive-list] li button.root_folder, ul[id^=drive-list] li ul[class^="child"] li button, li[id^=my-drive] i:nth-child(2), li[id^=share-drive] i:nth-child(2)', function () {
